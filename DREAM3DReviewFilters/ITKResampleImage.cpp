...
#define RESAMPLE2D_VARIABLECOMPONENT(sliceNo)                                                                                                                                                          \
  ...
  std::vector<size_t> tdims = {size[0], size[1], 1};                                                                                                                                                   \
...
//
// -----------------------------------------------------------------------------
void ITKResampleImage::WriteResampledCTFfile(const QString& filename, std::vector<IDataArray::Pointer> ctfArrays, SizeVec3Type dims, FloatVec3Type spacing, size_t index)
{
  QFile in(filename);
